...
namespace TurrantKar.EH {
  ...
  /// </summary>
  [Serializable]
 public class TKNullRequestArgumentException : TKRecoverableException {
    ...
    /// <inheritdoc />
    public TKNullRequestArgumentException()
      : base(_message, null) {
    }
    ...
    public TKNullRequestArgumentException(string message)
      : base(message, null) {
    }
    ...
    public TKNullRequestArgumentException(Exception innerException)
    ...
    /// <param name="innerException">Inner exception.</param>
    public TKNullRequestArgumentException(string message, Exception innerException)
 ...
 /// <summary>
    ...
    public TKNullRequestArgumentException(string message, IList<TKErrorData> dataList)
      : base(message, null) {
